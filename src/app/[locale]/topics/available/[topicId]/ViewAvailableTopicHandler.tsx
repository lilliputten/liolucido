...
interface TViewAvailableTopicHandlerProps extends TPropsWithClassName {
  topicId: TTopicId;
}

export function ViewAvailableTopicHandler(props: TViewAvailableTopicHandlerProps) {
  const { topicId } = props;
  ...
  if (!isTopicReady) {
    return (
      <div
        className={cn(
          isDev && '__ViewAvailableTopicHandler_Skeleton', // DEBUG
